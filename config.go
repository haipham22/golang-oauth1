...
func (c *Config) RequestToken(hasCallbackConfirm bool) (requestToken, requestSecret string, err error) {
	...
	if hasCallbackConfirm && values.Get(oauthCallbackConfirmedParam) != "true" {
